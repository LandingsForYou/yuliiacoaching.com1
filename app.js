...
const modalClose = document.querySelector(".about-modal-close");

readMoreButtons.forEach((btn) => {
  btn.addEventListener("click", () => {
    const block = btn.closest(".about-block");
    const title = block.querySelector("h3").innerText;
    const text = block.querySelector(".about-text").innerHTML;
...
const clientModalTitle = document.getElementById("modalTitle");
const clientModalDesc = document.getElementById("modalDesc");
const clientCloseBtn = document.querySelector(".modal-close");
const detailButtons = document.querySelectorAll(".client-card .btn");
...
detailButtons.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    clientModalDesc.textContent = desc;
